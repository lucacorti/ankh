defmodule Ankh.Frame.Utils do
  ...
  defp do_split(
         %Headers{stream_id: id, flags: flags, payload: %{hbf: hbf} = payload},
         frame_size,
         end_stream,
         frames
       )
  ...
  defp do_split(
         %Headers{flags: flags, payload: %{hbf: hbf} = payload} = frame,
         frame_size,
         end_stream,
         []
       ) do
    ...
    do_split(
      %Headers{frame | flags: %{flags | end_headers: false}, payload: %{hbf: rest}},
      frame_size,
      end_stream,
      frames
    )
  ...
  defp do_split(
         %Headers{stream_id: id, payload: %{hbf: hbf} = payload},
         frame_size,
         end_stream,
         frames
       ) do
