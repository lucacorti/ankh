defmodule Ankh.Protocol.HTTP3.Frame.GoAway do
  @moduledoc false

  defmodule Payload do
    @moduledoc false

    @type t :: %__MODULE__{stream_id: non_neg_integer()}
    ...
    defimpl Ankh.Protocol.HTTP3.Frame.Encodable do
      ...
      def encode(%@for{stream_id: id}), do: {:ok, Frame.encode_vli(id)}
      def encode(_payload), do: {:error, :encode_error}
    end
  end

  use Ankh.Protocol.HTTP3.Frame, type: 0x7, payload: Payload
end
